///////////////////////////////////////////////////////////
// Compressed Image Comparisons (Iterative)
//
// Description: Displays an image compressed to 
// different degrees. Uses iterative implementation.
///////////////////////////////////////////////////////////
// Input:
...
function compare_iterative(original_image, compression_rates)
    ...
    for i=1:n
        // Compress
        C = svd_compress_iterative(A, compression_rates(i));

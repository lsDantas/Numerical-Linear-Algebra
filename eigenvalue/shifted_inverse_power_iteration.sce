...
function [lambda, x1, counter, norm_error] = shifted_inverse_power_iteration(A, x0, epsilon, alpha, max_iter)
    ...
    x0 = x0/norm(x0,2);
    [x1, LU, P] = solve_gaussian_elimination(A - alpha * eye(n,n), x0);
    x1 = x1/norm(x1,2);
